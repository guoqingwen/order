...
$this->params['breadcrumbs'][] = ['label' => '注册营业点', 'url' => '?r=site/position'];
$this->params['breadcrumbs'][] = $this->title;
?>
   <form method="post" class="am-form am-form-horizontal" action="?r=site/addpos">
   <input type="hidden" name="_csrf" value='<?php Yii::$app->getRequest()->csrfParam; ?>'/>
	...
	<div class="am-form-group">
		...
		<div id="id_school" class="am-u-sm-10">
			<select name="s_id" class="prov">
    			  <option value ="港安驾校">港安驾校</option>
                  <option value ="深港驾校">深港驾校</option>
                  <option value="综安驾校">综安驾校</option>
                  <option value="南山驾校">南山驾校</option>
			</select> 
		</div>
	</div>
	<div class="am-form-group" >
