...
?>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">欢迎回来！！</strong> </div>
    </div>
...
<!--    留言回复先不做      -->
<!--         <div class="am-panel am-panel-default"> -->
<!--           <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-3'}">留言回复<span class="am-icon-chevron-down am-fr" ></span></div> -->
